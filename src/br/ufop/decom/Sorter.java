 ...
 * Sorts a randomly generated collection of integers.
 */
public class Sorter {
	
	/**
	 * Sorts a randomly generated collection of {@code amount} integers in the [{@code lowerBound}, {@code upperBound}) range
	 * @param amount the number of integers to be generated
	 * @param lowerBound the lower possible generated integer (inclusive)
	 * @param upperBound the higher possible generated integer (exclusive)
	 * @return the generated numbers sorted in a ordered map where the keys are the generated number and the value is the frequency of this number
	 */
